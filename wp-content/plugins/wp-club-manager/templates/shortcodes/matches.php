    ...
    <table>
		...
		foreach ( $matches as $match ) {
            ...
            <tr data-url="<?php echo esc_url( get_post_permalink( $match->ID, false, true ) ); ?>">
                <td class="wpcm-date">
                    <a class="wpcm-matches-href"
                        href="<?php echo esc_url( get_post_permalink( $match->ID, false, true ) ); ?>">
                        <?php echo esc_html( date_i18n( 'd M', $timestamp ) ); ?>,
                ...
                <?php } ?>
                <td class="result <?php echo esc_attr( $class ); ?>"><?php echo esc_html( $result[0] ); ?>
                    <?php echo ( $played ? '<span class="' . esc_attr( $class ) . '"></span>' : '' ); ?></td>
            </tr>
