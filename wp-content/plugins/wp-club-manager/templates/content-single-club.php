...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="wpcm-club-details wpcm-row">
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <th></th>
                    <td><a href="<?php echo esc_url( $details['website'] ); ?>"
                            target="_blank"><?php esc_html_e( 'Visit website', 'wp-club-manager' ); ?></a></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
    ...
    <h3><?php /* translators: 1: plugin name(s). */ echo esc_html( sprintf( __( 'Matches against %s', 'wp-club-manager' ), $post->post_title ) ); ?>
    </h3>
    ...
    <ul class="wpcm-h2h-list">
        <li class="wpcm-h2h-list-p" <?php echo esc_attr( $primary_color_bg ); ?>>
            <span class="wpcm-h2h-list-count"><?php echo esc_html( $outcome['total'] ); ?></span> <span
                class="wpcm-h2h-list-desc"><?php __( 'games', 'wp-club-manager' ); ?></span>
        </li>
        <li class="wpcm-h2h-list-w" <?php echo esc_attr( $primary_color_bg ); ?>>
            <span class="wpcm-h2h-list-count"><?php echo esc_html( $outcome['wins'] ); ?></span> <span
                class="wpcm-h2h-list-desc"><?php __( 'wins', 'wp-club-manager' ); ?></span>
        </li>
        <li class="wpcm-h2h-list-d" <?php echo esc_attr( $primary_color_bg ); ?>>
            <span class="wpcm-h2h-list-count"><?php echo esc_html( $outcome['draws'] ); ?></span> <span
                class="wpcm-h2h-list-desc"><?php __( 'draws', 'wp-club-manager' ); ?></span>
        </li>
        <li class="wpcm-h2h-list-l" <?php echo esc_attr( $primary_color_bg ); ?>>
            <span class="wpcm-h2h-list-count"><?php echo esc_html( $outcome['losses'] ); ?></span> <span
                class="wpcm-h2h-list-desc"><?php __( 'losses', 'wp-club-manager' ); ?></span>
        </li>
    </ul>
    ...
    <ul class="wpcm-matches-list">
        ...
        <li class="wpcm-matches-list-item <?php echo esc_attr( $class ); ?>">
            <a href="<?php echo esc_url( get_post_permalink( $match->ID, false, true ) ); ?>"
                ...
                <span class="wpcm-matches-list-col wpcm-matches-list-status">
                    Data there
                    <span
                        class="wpcm-matches-list-<?php echo ( $played ? 'result' : 'time' ); ?> <?php echo esc_attr( $class ); ?>">
