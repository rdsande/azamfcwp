...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const columnsData = {
      action: 'dase_get_columns_market_value_transitions',
    ...
    return [
      <div className="dase-block-image">{__('Market Value Transitions', 'dase')}</div>,
 ...
 */
registerBlockType('dase/market-value-transitions', {
  title: __('Market Value Transitions', 'dase'),
  icon: BallIcon,
  category: 'dase-soccer-engine',
  keywords: [
    __('market value transitions', 'dase'),
    __('soccer', 'dase'),
    __('engine', 'dase'),
  ],
  attributes: {
