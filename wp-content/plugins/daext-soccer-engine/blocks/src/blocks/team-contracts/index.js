...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const teamContractTypeIdData = {
      action: 'dase_get_team_contract_type_list',
      attributeName: 'teamContractTypeId',
      title: __('Team Contract Type', 'dase'),
    };

    const columnsData = {
      action: 'dase_get_columns_team_contracts',
    ...
    return [
      <div className="dase-block-image">{__('Team Contracts', 'dase')}</div>,
 ...
 */
registerBlockType('dase/team-contracts', {
  title: __('Team Contracts', 'dase'),
  icon: BallIcon,
