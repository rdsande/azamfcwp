...
class BlockEdit extends Component {
  ...
  render() {
    ...
    return [
      <div className="dase-block-image">{__('Match Visual Lineup', 'dase')}</div>,
 ...
 */
registerBlockType('dase/match-visual-lineup', {
  title: __('Match Visual Lineup', 'dase'),
  icon: BallIcon,
  category: 'dase-soccer-engine',
  keywords: [
    __('match visual lineup', 'dase'),
    __('soccer', 'dase'),
    __('engine', 'dase'),
  ],
  attributes: {
