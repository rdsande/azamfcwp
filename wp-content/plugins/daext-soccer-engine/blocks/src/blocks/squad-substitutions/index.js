...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const columnsData = {
      action: 'dase_get_columns_squad_substitutions',
    ...
    return [
      <div className="dase-block-image">{__('Squad Substitutions', 'dase')}</div>,
 ...
 */
registerBlockType('dase/squad-substitutions', {
  title: __('Squad Substitutions', 'dase'),
  icon: BallIcon,
  category: 'dase-soccer-engine',
  keywords: [
    __('squad substitutions', 'dase'),
    __('soccer', 'dase'),
    __('engine', 'dase'),
  ],
  attributes: {
