...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const agencyIdData = {
      action: 'dase_get_agency_list',
      attributeName: 'agencyId',
      title: __('Agency', 'dase'),
    };

    const agencyContractTypeIdData = {
      action: 'dase_get_agency_contract_type_list',
      attributeName: 'agencyContractTypeId',
      title: __('Agency Contract Type', 'dase'),
    };

    const columnsData = {
      action: 'dase_get_columns_agency_contracts',
    ...
    return [
      <div className="dase-block-image">{__('Agency Contracts', 'dase')}</div>,
 ...
 */
registerBlockType('dase/agency-contracts', {
  title: __('Agency Contracts', 'dase'),
  icon: BallIcon,
