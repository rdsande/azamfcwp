...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const unavailablePlayerTypeIdData = {
      action: 'dase_get_unavailable_player_type_list',
      attributeName: 'unavailablePlayerTypeId',
      title: __('Unavailable Player Type', 'dase'),
    };

    const columnsData = {
      action: 'dase_get_columns_unavailable_players',
    ...
    return [
      <div className="dase-block-image">{__('Unavailable Players', 'dase')}</div>,
 ...
 */
registerBlockType('dase/unavailable-players', {
  title: __('Unavailable Players', 'dase'),
  icon: BallIcon,
