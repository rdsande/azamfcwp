...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const playerAwardTypeIdData = {
      action: 'dase_get_player_award_type_list',
      attributeName: 'playerAwardTypeId',
      title: __('Player Award Type', 'dase'),
    };

    const columnsData = {
      action: 'dase_get_columns_player_awards',
    ...
    return [
      <div className="dase-block-image">{__('Player Awards', 'dase')}</div>,
 ...
 */
registerBlockType('dase/player-awards', {
  title: __('Player Awards', 'dase'),
  icon: BallIcon,
