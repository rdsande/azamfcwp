...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const columnsData = {
      action: 'dase_get_columns_match_substitutions',
    ...
    return [
      <div className="dase-block-image">{__('Match Substitutions', 'dase')}</div>,
 ...
 */
registerBlockType('dase/match-substitutions', {
  title: __('Match Substitutions', 'dase'),
  icon: BallIcon,
  category: 'dase-soccer-engine',
  keywords: [
    __('match substitutions', 'dase'),
    __('soccer', 'dase'),
    __('engine', 'dase'),
  ],
  attributes: {
