...
class BlockEdit extends Component {
  ...
  constructor(props) {
    ...
    if(typeof this.props.attributes.columns === 'undefined'){
      this.props.setAttributes({columns: ['team', 'appearances', 'won', 'drawn', 'lost', 'yellow_cards', 'red_cards']});
    }
  ...
  render() {
    ...
    const columnsData = {
      action: 'dase_get_columns_referee_statistics_by_team',
    ...
    return [
      <div className="dase-block-image">{__('Referee Statistics by Team', 'dase')}</div>,
 ...
 */
registerBlockType('dase/referee-statistics-by-team', {
  title: __('Referee Statistics by Team', 'dase'),
  icon: BallIcon,
  category: 'dase-soccer-engine',
  keywords: [
    __('referee statistics by team', 'dase'),
    __('soccer', 'dase'),
    __('engine', 'dase'),
  ],
  attributes: {
